...
void main() {
  group('Marker Animation Tests', () {
    ...
    group('MarkerScaler', () {
      testWidgets('should scale the marker icon and return a BitmapDescriptor',
          (tester) async {
        final markerScaler = MarkerScaler(assetPath: 'assets/map_marker.png');
        final icon =
            await markerScaler.createBitmapDescriptor(Size(60.0, 60.0));
    ...
    group('MarkerDraggableSheet', () {
      testWidgets('should trigger animateMarkers when collapsed',
          (tester) async {
      ...
      testWidgets(
        ...
        expect(triggered, false); // Ensure that the animation was not triggered
      });
    });
    ...
    group('MarkerDraggableSheetPage', () {
      testWidgets(
          ...
          (tester) async {
        final selectedMarkerIdNotifier =
            ValueNotifier<MarkerId?>(MarkerId(validMarkerId));
        await tester.pumpWidget(MaterialApp(
